...
#define BT1P2_FEATURE_HI  ( \
    ...
    |   RM_LMP_FEATURES_BYTE4_AFH_CAPABLE_PERIPHERAL\
    |   RM_LMP_FEATURES_BYTE4_AFH_CLASSIFICATION_PERIPHERAL\
    |   RM_LMP_FEATURES_BYTE5_AFH_CAPABLE_CENTRAL\
    |   RM_LMP_FEATURES_BYTE5_AFH_CLASSIFICATION_CENTRAL\
