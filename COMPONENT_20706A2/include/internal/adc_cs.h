...
typedef union ADC_CTL1_REG
{
    ...
    struct
    {
        ...
        /// bit 15:12   -   MIC PGA gain control: 3dB steps
        /// 0000 : 0dB; 0001 : 3dB; 0010 : 6dB; 1110 : 42dB
        UINT32  micPgaGainCtl           : 4;
...
enum
{
    ...
    // bit 15:12
    CTL1_REG_ADC_MIC_PGA_GAIN_CTL_0dB           =   0x0,
    CTL1_REG_ADC_MIC_PGA_GAIN_CTL_3dB           =   0x1,
    CTL1_REG_ADC_MIC_PGA_GAIN_CTL_6dB           =   0x2,
    CTL1_REG_ADC_MIC_PGA_GAIN_CTL_9dB           =   0x3,
    CTL1_REG_ADC_MIC_PGA_GAIN_CTL_12dB          =   0x4,
    CTL1_REG_ADC_MIC_PGA_GAIN_CTL_15dB          =   0x5,
    CTL1_REG_ADC_MIC_PGA_GAIN_CTL_18dB          =   0x6,
    CTL1_REG_ADC_MIC_PGA_GAIN_CTL_21dB          =   0x7,
    CTL1_REG_ADC_MIC_PGA_GAIN_CTL_24dB          =   0x8,
    CTL1_REG_ADC_MIC_PGA_GAIN_CTL_27dB          =   0x9,
    CTL1_REG_ADC_MIC_PGA_GAIN_CTL_30dB          =   0xA,
    CTL1_REG_ADC_MIC_PGA_GAIN_CTL_33dB          =   0xB,
    CTL1_REG_ADC_MIC_PGA_GAIN_CTL_36dB          =   0xC,
    CTL1_REG_ADC_MIC_PGA_GAIN_CTL_39dB          =   0xD,
    CTL1_REG_ADC_MIC_PGA_GAIN_CTL_42dB          =   0xE,

    CTL1_REG_ADC_MIC_PGA_GAIN_CTL_DEFAULT       =   CTL1_REG_ADC_MIC_PGA_GAIN_CTL_0dB ,
...
typedef union FILTER_CTLC_REG
{
    ...
    struct
    {
        ...
        UINT32 auxAdcSpare3         : 16;

        /// bit 31:16   -   spare register
        UINT32 auxAdcSpare4         : 16;
    }bitmap;
}FILTER_CTLC_REG;
...
typedef union FILTER_CTLD_REG
{
    ...
    {
        /// bit 15:0    -   spare register
        UINT32 auxAdcSpare5         : 16;

        /// bit 31:16   -   spare register
        UINT32 auxAdcSpare6           : 16;
    }bitmap;
}FILTER_CTLD_REG;
...
typedef union FILTER_CTLE_REG
{
    ...
    {
        /// bit 15:0    -   spare register
        UINT32 auxAdcSpare7         : 16;

        /// bit 31:16   -   spare register
        UINT32 auxAdcSpare8           : 16;
    }bitmap;
}FILTER_CTLE_REG;
...
//CQ BLTH02708075 Declare the the following functions as extern "C" if C++
#ifdef __cplusplus
extern "C" {
#endif
...
void adc_startAudio(UINT32 sampleRate, UINT32 bitsPerSample, void (*func)(UINT8 *, UINT32, UINT32));

/// Stop ADC Audio mode
void adc_stopAudio(void);

/// Check whether ADC Audio is activated
BOOL adc_AudioIsActive(void);

//CQ BLTH02708075 close extern "C" bracket
#ifdef __cplusplus
}
#endif
