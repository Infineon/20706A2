...
* reference the Kit Guide for more information regarding your
* specific platform.
*
...
{
    extern UINT8 adcRead_WaitForBTClockEnabled;
    adcRead_WaitForBTClockEnabled = 1;
    adc_config();
}
...
///////////////////////////////////////////////////////////////////////////////
static INLINE INT16 wiced_hal_adc_read_raw_sample(
                                  ADC_INPUT_CHANNEL_SEL channel)
{
    return adc_readSampleRaw(channel);
}
...
{
    return adc_readVoltage(channel);
}
