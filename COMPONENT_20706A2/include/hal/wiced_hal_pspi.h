...
// and slave modes, please reference the Kit Guide, since the values
...
///                           Kit Guide for specific values which
///                           vary by platform).
...
void wiced_hal_pspi_init_patch(UINT8           devRole,
...
{
    spiffyd_txData(SPIFFYD_1, txLen, txBuf);
}
...
{
    spiffyd_rxData(SPIFFYD_1, rxLen, rxBuf);
}
...
static INLINE void wiced_hal_pspi_exchange_data(UINT32 len,
                                                ...
                                                UINT8* rxBuf)
{
    spiffyd_exchangeData(SPIFFYD_1, len, txBuf, rxBuf);
}
...
{
    spiffyd_slaveEnableTx(SPIFFYD_1);
}
...
{
    spiffyd_slaveDisableTx(SPIFFYD_1);
}
...
{
    spiffyd_slaveEnableRx(SPIFFYD_1);
}
...
{
    spiffyd_slaveDisableRx(SPIFFYD_1);
}
...
static INLINE void wiced_hal_pspi_slave_tx_data(UINT32 txLen,
                                                const UINT8* txBuf)
{
    spiffyd_slaveTxData(SPIFFYD_1, txLen, txBuf);
}
...
static INLINE SPIFFY_STATUS wiced_hal_pspi_slave_rx_data(UINT32 rxLen,
                                                         UINT8* rxBuf)
{
    return spiffyd_slaveRxData(SPIFFYD_1, rxLen, rxBuf);
}
...
{
    return spiffyd_slaveGetTxFifoCount(SPIFFYD_1);
}
...
{
    return spiffyd_slaveGetRxFifoCount(SPIFFYD_1);
}
