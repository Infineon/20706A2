...
#define wiced_bt_connection_status_change_cback_t               tBTM_ACL_DB_CHANGE_CB_EXT   /* modified from bte */
...
#define wiced_bt_a2d_service_t                                  tA2D_Service
#define wiced_bt_a2d_sdp_db_params_t                            tA2D_SDP_DB_PARAMS
#define wiced_bt_a2d_find_cback                                 tA2D_FIND_CBACK
